...
export default class InstructionRowRender extends Component {
  state = {
    dataSource: []
  };
  componentDidMount() {
    ...
    let params = {
      // ...page,
      depositOrganVal: '1', //托管机构2上清 1.中债3.托管行
...
//   const { asyncHttpQueryZJDListQf, qfTable } = props;
//   let datas = [];
//   const columns = [
...
//   let params = {
//     ...page,
//     depositOrganVal: '3', //托管机构1上清 2.中债3.托管行
//     bizCategory: 3, //业务类型
//     execCode: 'CR2020032000030108', //成交编号
//     tradeDirection: 4 //交易方向
//   };
// depositOrganVal:"3",//托管机构1上清 2.中债3.托管行
// bizCategory:row.bizCategory,//业务类型
// execCode:row.execCode,//成交编号
// tradeDirection:row.entrustSide//交易方

// asyncHttpQueryZJDListQf({ params });
// datas = qfTable;
// return
