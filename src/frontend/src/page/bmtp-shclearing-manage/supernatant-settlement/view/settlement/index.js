...
class Settlement extends Component {
  ...
  async componentDidMount() {
    const { asyncHttpSqDebtList, asyncGetBusinessType } = this.props;
    await authModels.mutations
      .asyncHttpPermitVerity({ type: 'supernatant-settlement', functionCode, source })
      .then(() => {
...
export default $connect(Settlement, 'bmtp-shclearing-manage/supernatant-settlement');
